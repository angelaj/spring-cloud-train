...
import com.train.common.date.DateUtil;
import com.train.common.exceptions.ValidateException;
import com.train.common.util.NumberUtil;
...
public class Validator {
	...
	public static boolean isLetter(CharSequence value) {
		return StrUtil.isAllCharMatch(value, new com.train.common.lang.Matcher<Character>() {
			@Override
