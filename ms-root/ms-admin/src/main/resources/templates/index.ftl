...
<head>
    ...
    <script type="text/javascript" src="${ctx!}/assets/js/plugins/layer/layer.min.js"></script>
    <script type="text/javascript" src="${ctx!}/assets/js/hplus.min.js?v=4.1.0"></script>
    ...
    <script type="text/javascript" src="${ctx!}/app/js/index.js"></script>
...
<div id="wrapper">
            ...
            <ul class="nav" id="side-menu">
                <li class="nav-header">
                    <div class="dropdown profile-element">
                        <span><img alt="image" class="img-circle" src="${ctx!}/assets/img/profile_small.jpg" /></span>
                        <a data-toggle="dropdown" class="dropdown-toggle" href="#">
									<span class="clear">
                               <span class="block m-t-xs"><strong class="font-bold">JYY</strong></span>
                ...
                <li>
                    <a class="J_menuItem" href="${ctx!}/welcome">
                                ...
                                <#if children?? && children?size gt 0>
                                    <#list children as child>
                                        <#if child.children?? && child.children?size gt 0>
											<li>
                                                <a href="${child.resourceUrl}" data-id="${child.id}" data-name="${child.resourceName}">
                                                    <i class="fa fa ${child.icon}"></i>
                                                    <span class="nav-label">${child.resourceName}</span>
                                                    <span class="fa arrow"></span>
                                                </a>
                                                <ul class="nav"id="nav_${child.id}">
														<@bpTree children=child.children />
                                                </ul>
                                            </li>
                                        <#else>
											<li >
                                                <a class="J_menuItem" href="${child.resourceUrl}" data-id="${child.id}" data-name="${child.resourceName}">
                                                    <i class="fa fa ${child.icon}"></i>
                                                    <span class="nav-label">${child.resourceName}</span>
                                                </a>
                                            </li>
    ...
    <div id="page-wrapper" class="gray-bg dashbard-1">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-messages">
                            <li class="m-t-xs">
                                <div class="dropdown-messages-box">
                                    <a href="profile.html" class="pull-left">
                                        <img alt="image" class="img-circle" src="${ctx!}/assets/img/a7.jpg">
                                    </a>
                            ...
                            <li>
                                <div class="dropdown-messages-box">
                                    <a href="profile.html" class="pull-left">
                                        <img alt="image" class="img-circle" src="${ctx!}/assets/img/a4.jpg">
                                    </a>
                                    <div class="media-body ">
        ...
        <div class="row J_mainContent" id="content-main">
            <iframe class="J_iframe" name="iframe0" width="100%" height="100%" src="${ctx!}/welcome" frameborder="0" seamless></iframe>
        </div>
        <div class="footer">
                ...
                <div id="tab-2" class="tab-pane">
                    ...
                    <div>
                        <div class="sidebar-message">
                            <a href="#">
                                <div class="pull-left text-center">
                                    <img alt="image" class="img-circle message-avatar" src="${ctx!}/assets/img/a1.jpg">
                                    <div class="m-t-xs">
                        ...
                        <div class="sidebar-message">
                            <a href="#">
                                <div class="pull-left text-center">
                                    <img alt="image" class="img-circle message-avatar" src="${ctx!}/assets/img/a2.jpg">
                                </div>
                                <div class="media-body">
                        ...
                        <div class="sidebar-message">
                            <a href="#">
                                <div class="pull-left text-center">
                                    <img alt="image" class="img-circle message-avatar" src="${ctx!}/assets/img/a3.jpg">
                        ...
                        <div class="sidebar-message">
                            <a href="#">
                                <div class="pull-left text-center">
                                    <img alt="image" class="img-circle message-avatar" src="${ctx!}/assets/img/a4.jpg">
                                </div>
                        ...
                        <div class="sidebar-message">
                            <a href="#">
                                <div class="pull-left text-center">
                                    <img alt="image" class="img-circle message-avatar" src="${ctx!}/assets/img/a8.jpg">
                                </div>
                                <div class="media-body">
                        ...
                        <div class="sidebar-message">
                            <a href="#">
                                <div class="pull-left text-center">
                                    <img alt="image" class="img-circle message-avatar" src="${ctx!}/assets/img/a7.jpg">
                                </div>
                                <div class="media-body">
